...
# include the host genome fasta file in the same directory as this script. 
# In this case, smeg_sequence.fasta contains the smegmatis genome (host organism)
...
#run with python3 -u Trimmomatic_script.py | tee Trimmomatic_script.log
